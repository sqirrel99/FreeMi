                    ...
                    if (sessions.ContainsKey(addr) == false)
                    {
                        try
                        {
                            if (addr.AddressFamily == AddressFamily.InterNetwork)
                            {
                                ...
                                try { if (!Utils.IsMono()) session.Client.IOControl(SIO_UDP_CONNRESET, inValue, outValue); }
                                catch (SocketException ex)
                                {
                                    OpenSource.Utilities.EventLogger.Log(ex);
                                }
                                ...
                                try { if (!Utils.IsMono()) usession.Client.IOControl(SIO_UDP_CONNRESET, inValue, outValue); }
                                catch (SocketException ex)
                                {
                                    OpenSource.Utilities.EventLogger.Log(ex);
                                }
